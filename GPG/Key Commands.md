...
```bash
$ gpg2 --armour --output revoke-key.asc --gen-revoke <email_address>
...
```bash
$ gpg2 --export --armor --output public-key.asc <email_address>
 -rw-r--r-- 1 root root 3.1K Aug 23 06:33 public-key.asc
 
$ gpg2 --export-secret-keys --armor --output private-key.asc <email_address>
